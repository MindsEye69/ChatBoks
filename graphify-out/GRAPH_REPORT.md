...
## Corpus Check
- 86 files · ~107,167 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1176 nodes · 2971 edges · 61 communities (52 shown, 9 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 237 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f8b2186a`
...
2. `Router` - 69 edges
3. `Stream` - 68 edges
4. `AgentZeroAgent` - 63 edges
5. `_router()` - 63 edges
6. `ContextBuilder` - 59 edges
7. `Any` - 37 edges
8. `Path` - 37 edges
...
Cohesion: 0.07
Nodes (31): Connection, ContextBuilder, Any, Path, Any, Path, Small deterministic fallback summarizer.      The design allows this to become a, Summarizer (+23 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (7): test_stream_help_box_contains_bbs_frame_and_commands(), test_stream_help_pin_contains_compact_commands(), test_stream_standby_uses_agent_label(), test_stream_token_usage_renders_session_bars(), Text, ThoughtPacket, Stream
...
Cohesion: 0.21
Nodes (21): ask(), build_post_commit_hook(), default_config_path(), ensure_agent_zero_ollama(), ensure_codegraph(), ensure_node(), ensure_project_codegraph(), ensure_project_hook() (+13 more)
...
Cohesion: 0.08
Nodes (37): clean_list(), extract_packets(), normalize_value(), packet_records_from_jsonl(), parse_packet_body(), Any, ThoughtPacket, FileSystemEventHandler (+29 more)
...
Cohesion: 0.31
Nodes (15): _make_app(), Chatboks, Path, Smoke tests for the local /help command., test_codegraph_status_lines_reads_sqlite_counts(), test_graph_command_renders_without_agent_round(), test_graphify_status_lines_reports_fresh_graph(), test_graphify_status_lines_reports_stale_graph() (+7 more)
...
## Knowledge Gaps
- **99 isolated node(s):** `allow`, `Path`, `Any`, `Any`, `appId` (+94 more)
...
- **Why does `Chatboks` connect `Community 44` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 8`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 16`, `Community 45`, `Community 46`, `Community 47`, `Community 48`, `Community 49`, `Community 52`, `Community 53`, `Community 56`, `Community 57`, `Community 58`?**
  _High betweenness centrality (0.373) - this node is a cross-community bridge._
- **Why does `Router` connect `Community 4` to `Community 0`, `Community 1`, `Community 3`, `Community 6`, `Community 7`, `Community 10`, `Community 11`, `Community 44`, `Community 13`, `Community 46`, `Community 48`?**
